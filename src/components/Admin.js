...
const Admin = (props) => {
  ...
  useEffect(() => {
    ...
    if (teamFilter === "All" && priceFilter === "LtoM") {
      ...
      for (let i = 0; i < allProducts.length; i++) {
        if (allProducts[i].teamName === teamFilter) {
          teamHolder.push(allProducts[i]);
        }
      }
      ...
      let divisionHolder = [];
      for (let i = 0; i < allProducts.length; i++) {
        if (allProducts[i].division === teamFilter) {
          divisionHolder.push(allProducts[i]);
        }
      }
  ...
  function getTeamColors(team) {
    if (team === "Minnesota Vikings") {
      return {
        ...
        buttonT: "buttonPurpleT",
        buttonB: "buttonPurpleB",
      };
      ...
      return {
        background: "gradientOrangeDark",
        buttonT: "buttonNavyBlueT",
        buttonB: "buttonNavyBlueB",
      };
    } else if (team === "Arizona Cardinals") {
      return {
        background: "gradientBlack",
        buttonT: "buttonCardinalRedT",
        buttonB: "buttonCardinalRedB",
      };
    } else if (team === "Indianapolis Colts") {
      return {
        background: "gradientBarelyGray",
        buttonT: "buttonRoyalBlueT",
        buttonB: "buttonRoyalBlueB",
      };
      ...
      return {
        background: "gradientGold",
        buttonT: "buttonScarletRedT",
        buttonB: "buttonScarletRedB",
      };
    } else if (team === "Seattle Seahawks") {
      return {
        background: "gradientLimeGreen",
        buttonT: "buttonDarkAquaT",
        buttonB: "buttonDarkAquaB",
      };
      ...
      return {
        background: "gradientGoldMetallic",
        buttonT: "buttonBlackT",
        buttonB: "buttonBlackB",
      };
      ...
      return {
        background: "gradientBlack",
        buttonT: "buttonPantherBlueT",
        buttonB: "buttonPantherBlueB",
      };
      ...
      return {
        background: "gradientOrangeBrowns",
        buttonT: "buttonBrownT",
        buttonB: "buttonBrownB",
      };
      ...
      return {
        background: "gradientPewter",
        buttonT: "buttonBucsRedT",
        buttonB: "buttonBucsRedB",
      };
    } else if (team === "Dallas Cowboys") {
      return {
        background: "gradientGray",
        buttonT: "buttonDarkBlueT",
        buttonB: "buttonDarkBlueB",
      };
      ...
      return {
        background: "gradientBlack",
        buttonT: "buttonMidnightGreenT",
        buttonB: "buttonMidnightGreenB",
      };
    } else if (team === "Washington Commanders") {
      return {
        background: "gradientOrangeGold",
        buttonT: "buttonBurgundyT",
        buttonB: "buttonBurgundyB",
      };
    } else if (team === "Houston Texans") {
      return {
        background: "gradientBattleRed",
        buttonT: "buttonDeepSteelBlueT",
        buttonB: "buttonDeepSteelBlueB",
      };
      ...
      return {
        ...
        buttonT: "buttonOrangeT",
        buttonB: "buttonOrangeB",
      };
    } else if (team === "Kansas City Chiefs") {
      return {
        background: "gradientGoldDarker",
        buttonT: "buttonRedT",
        buttonB: "buttonRedB",
      };
      ...
      return {
        background: "gradientGold",
        buttonT: "buttonPowderBlueT",
        buttonB: "buttonPowderBlueB",
      };
    } else {
      return {
        background: "admin_product",
        buttonT: "buttonBGT",
        buttonB: "buttonBGB",
      };
    }
  ...
  function getButtonMtoL() {
    if (priceFilter === "MtoL") {
      return (
        <button className="button_new_selected" onClick={filterByPriceMtoL}>
          Most to Least Expensive
        </button>
      );
    } else {
      return (
        <button className="button_new" onClick={filterByPriceMtoL}>
          Most to Least Expensive
        </button>
      );
    }
  ...
  function getButtonLtoM() {
    if (priceFilter === "LtoM") {
      return (
        <button className="button_new_selected" onClick={filterByPriceLtoM}>
          Least to Most Expensive
        </button>
      );
    } else {
      return (
        <button className="button_new" onClick={filterByPriceLtoM}>
          Least to Most Expensive
        </button>
      );
    }
  ...
  return (
    <div>
              ...
              <div key={idx} className={teamColors.background}>
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    setCurrentProduct({
                      id: eachProduct.id,
                      playerName: eachProduct.playerName,
                      jerseyNumber: eachProduct.jerseyNumber,
                      teamName: eachProduct.teamName,
                      division: eachProduct.division,
                      price: eachProduct.price,
                      image: eachProduct.image,
                    });
                  }}
                  className={teamColors.buttonB}
                >
                  Edit Product
                </button>
              </div>
      ...
      {currentUser.admin && !formToggle && teamFilter !== "All" ? (
        <div className="admin_main">
          {holdAllProducts.map((eachProduct, idx) => {
            let teamColors = getTeamColors(eachProduct.teamName);
