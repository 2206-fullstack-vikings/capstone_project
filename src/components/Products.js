                ...
                <div className="admin_main">{allProducts.map((eachProduct,idx)=>{
                    ...
                    return <div key={idx} className={teamColors.background}>
                        <div className="image_container">
                          ...
                          <button className={teamColors.buttonT}  onClick={()=>addToCart(eachProduct.id)}>Add to Cart</button>
                               <br />
                    <button className={teamColors.buttonB} onClick={()=>navigate(`/${eachProduct.id}`)}>See Details</button>
                    </div>
                })}</div>: null
            }
            {
